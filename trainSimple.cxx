...
void trainSimple( TString myMethodList = "", TString outfileName = "TMVAReg.root" ) {
...
//    dataloader->AddVariable( "ES_plane1+ES_plane2",   "ES"  , "GeV", 'F' );
   ...
   dataloader->AddVariable( "HCAL_depth4", "HCAL_depth4", "GeV", 'F' );
...
//    TString fname = "added.small.root";
   TString fname = "addedmerged.root";
