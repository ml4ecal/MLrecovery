...
void trainExample( TString myMethodList = "", TString outfileName = "TMVAReg.root" ) {
...
//    TString outfileName( "TMVAReg.root" );
   ...
   dataloader->AddTarget( "tar1" );
   dataloader->AddTarget( "tar2" );
   dataloader->AddTarget( "tar3" );
